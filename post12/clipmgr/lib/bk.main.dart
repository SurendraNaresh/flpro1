import 'dart:convert';
import 'dart:io';
imprt  'package:futter/path/path.dart' as p;
...
//  final yt = YoutubeExplode();        // removed WatchHistory
  ...
  Future<void> checkExistingVideos() async {
    ...
    final dir = p.join(Directory.current.path,"output");
  ...
  Future<void> downloadVideo(String url) async {
    ...
    final savedDir = p.join(outDir,"output")//await getApplicationDocumentsDirectory();
